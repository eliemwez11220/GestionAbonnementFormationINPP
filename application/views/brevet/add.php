    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Brevet Add</h3>
            </div>
            <?php echo form_open('brevet/add'); ?>
          	<div class="box-body">
          		<div class="row clearfix">
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="candidat_sid" class="form-control">
								...
								{
									$selected = ($candidat['cand_id'] == $this->input->post('candidat_sid')) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="dateBrevet" value="<?php echo $this->input->post('dateBrevet'); ?>" class="has-datepicker form-control" id="dateBrevet" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="pourcentage" class="control-label"><span class="text-danger">*</span>Pourcentage</label>
						<div class="form-group">
							<input type="text" name="pourcentage" value="<?php echo $this->input->post('pourcentage'); ?>" class="form-control" id="pourcentage" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="mention" value="<?php echo $this->input->post('mention'); ?>" class="form-control" id="mention" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="coteObtenue" value="<?php echo $this->input->post('coteObtenue'); ?>" class="form-control" id="coteObtenue" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="specialite" class="control-label">Specialite</label>
						<div class="form-group">
							<input type="text" name="specialite" value="<?php echo $this->input->post('specialite'); ?>" class="form-control" id="specialite" />
						</div>
					</div>
				</div>
			</div>
