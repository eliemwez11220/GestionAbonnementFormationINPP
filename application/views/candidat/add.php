    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Candidat Add</h3>
            </div>
            <?php echo form_open('candidat/add'); ?>
          	<div class="box-body">
          		<div class="row clearfix">
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="sexe" class="form-control">
								...
								{
									$selected = ($value == $this->input->post('sexe')) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="etatCivil" class="form-control">
								...
								{
									$selected = ($value == $this->input->post('etatCivil')) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="noms" value="<?php echo $this->input->post('noms'); ?>" class="form-control" id="noms" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="dateNaissance" value="<?php echo $this->input->post('dateNaissance'); ?>" class="has-datepicker form-control" id="dateNaissance" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="niveauEtude" value="<?php echo $this->input->post('niveauEtude'); ?>" class="form-control" id="niveauEtude" />
