    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Domaine Add</h3>
            </div>
            <?php echo form_open('domaine/add'); ?>
          	<div class="box-body">
          		<div class="row clearfix">
					<div class="col-md-6">
						<label for="dateAjout" class="control-label">DateAjout</label>
						<div class="form-group">
							<input type="text" name="dateAjout" value="<?php echo $this->input->post('dateAjout'); ?>" class="has-datetimepicker form-control" id="dateAjout" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="intituleDom" class="control-label"><span class="text-danger">*</span>IntituleDom</label>
						<div class="form-group">
							<input type="text" name="intituleDom" value="<?php echo $this->input->post('intituleDom'); ?>" class="form-control" id="intituleDom" />
