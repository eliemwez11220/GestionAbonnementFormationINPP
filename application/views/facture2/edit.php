			...
			<div class="box-body">
				<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="client_sid" value="<?php echo ($this->input->post('client_sid') ? $this->input->post('client_sid') : $facture['client_sid']); ?>" class="form-control" id="client_sid" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="etat_facture" class="control-label">Etat Facture</label>
						<div class="form-group">
							<input type="text" name="etat_facture" value="<?php echo ($this->input->post('etat_facture') ? $this->input->post('etat_facture') : $facture['etat_facture']); ?>" class="form-control" id="etat_facture" />
						</div>
					</div>
				</div>
			</div>
