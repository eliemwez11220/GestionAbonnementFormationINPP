    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Inscription Add</h3>
            </div>
            <?php echo form_open('inscription/add'); ?>
          	<div class="box-body">
          		<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="formation_sid" class="form-control">
								...
								{
									$selected = ($formation['forma_id'] == $this->input->post('formation_sid')) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="dateInscription" value="<?php echo $this->input->post('dateInscription'); ?>" class="has-datetimepicker form-control" id="dateInscription" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="statutInscription" class="control-label">StatutInscription</label>
						<div class="form-group">
							<input type="text" name="statutInscription" value="<?php echo $this->input->post('statutInscription'); ?>" class="form-control" id="statutInscription" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="dateValidation" class="control-label">DateValidation</label>
						<div class="form-group">
							<input type="text" name="dateValidation" value="<?php echo $this->input->post('dateValidation'); ?>" class="has-datepicker form-control" id="dateValidation" />
						</div>
					</div>
					<div class="col-md-6">
