          	...
          	<div class="box-body">
          		<div class="row clearfix">
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="formateur_sid" class="form-control">
								...
								{
									$selected = ($formateur['ens_id'] == $this->input->post('formateur_sid')) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="dateInterv" value="<?php echo $this->input->post('dateInterv'); ?>" class="has-datepicker form-control" id="dateInterv" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="statutInter" class="control-label">StatutInter</label>
						<div class="form-group">
							<input type="text" name="statutInter" value="<?php echo $this->input->post('statutInter'); ?>" class="form-control" id="statutInter" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="effectifCandidats" class="control-label">EffectifCandidats</label>
						<div class="form-group">
							<input type="text" name="effectifCandidats" value="<?php echo $this->input->post('effectifCandidats'); ?>" class="form-control" id="effectifCandidats" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="matiereVue" class="control-label">MatiereVue</label>
						<div class="form-group">
							<textarea name="matiereVue" class="form-control" id="matiereVue"><?php echo $this->input->post('matiereVue'); ?></textarea>
						</div>
					</div>
					<div class="col-md-6">
